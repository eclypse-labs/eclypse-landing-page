        ...
        <div>
                <MobileOnly>
                    ...
                    {show && <div className="w-screen h-screen absolute top-0 right-0 duration-300" id="navbar-hamburger">
                        <ul className="flex flex-col h-full items-center justify-center p-0 mt-0 pt-[100px] z-10  rounded-sm  md:flex-row  md:mt-0 md:text-sm md:font-medium bg-gray-800/80 filter backdrop-blur-md ">
                        <li>
